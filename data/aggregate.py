...
def fixed_dataset() -> pd.DataFrame:
    ...
    flight_list = pd.concat(
        ...
        for file in
        Path(r"C:\Users\avjin\Documents\Python\Flight_Tracker\data_set").glob("flightlist_*.csv.gz")
    )
    return flight_list
...
def forming_dataset(*, start_time: str, end_time: str) -> pd.DataFrame:
    ...
    total_df.to_csv(r"C:\Users\avjin\Documents\Python\Flight_Tracker\data_to_ignore\out.zip",
